    ...
    <div class="panel-body">
     <form method="post" ng-submit="submitLogin()">
      ...
      <div class="form-group" align="center">
       ...
       <br />
       <input type="button" name="register_link" class="btn btn-primary btn-link" ng-click="showRegister()" value="Register" /><br/>
       <input type="button" name="login_link" class="btn btn-primary btn-link" ng-click="showLogin()" value="Forget your Password ?" />
      </div>
     </form>
    </div>
   </div>
